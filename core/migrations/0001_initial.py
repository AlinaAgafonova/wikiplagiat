# Generated by Django 5.0.4 on 2024-04-06 07:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lock_reason', models.CharField(blank=True, max_length=500, null=True)),
                ...
                ('editors', models.ManyToManyField(related_name='edited_articles', to=settings.AUTH_USER_MODEL)),
